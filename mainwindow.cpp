...
void MainWindow::CreateMenus()
{
    ...
    ActionNew->setToolTip("Create New File");
    toolBar->addAction(ActionNew);

    QAction *ActionOpen = FileMenu->addAction(tr("Open"),QKeySequence("ctrl + O"));
    connect(ActionOpen, &QAction::triggered, this, &MainWindow::OpenFile);
    ActionOpen->setToolTip(tr("Open file from computer"));
    ...
    ActionSaveCopy->setToolTip(tr("Save copy text to another file"));
    ...
    ActionSaveAll->setToolTip(tr("save all the file"));
    ...
    ActionCloseAllFile->setToolTip(tr("Close All the files"));
    ...
    ActionCloseOtherFiles->setToolTip(tr("Close All the files except current one"));
